    ...
    <div className="group rounded-2xl p-5 flex flex-col gap-3 bg-white border border-stone-200 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition">
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {event.currentUserRsvp && (
            <span
              className={`text-xs font-bold px-2.5 py-0.5 rounded-full border capitalize ${
                event.currentUserRsvp === "yes"
                  ? "bg-green-100 text-green-800 border-green-300"
                  : event.currentUserRsvp === "no"
          ...
          {eventTags.length > 2 && (
            <span className="text-xs px-2 py-0.5 rounded-full text-stone-600 bg-stone-100 border border-stone-200">
              +{eventTags.length - 2}
            </span>
          )}
        </div>
      ...
      <div className="flex items-center justify-between pt-3 mt-auto border-t border-stone-100">
        <div className="flex items-center gap-1.5 text-stone-500">
          ...
          <span className="text-xs">{formatTime(event.DateTime)}</span>
        </div>
