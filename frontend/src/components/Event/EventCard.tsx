...
const EventCard = ({ event, tags, onEdit, onView, onDelete, userId }: EventCardProps) => {
    ...
    return (
        <div className="group rounded-2xl p-5 flex flex-col gap-3 bg-white border border-stone-200 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition">
            <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition">
                    ...
                    <button
                        ...
                        className="w-7 h-7 rounded-lg flex items-center justify-center text-stone-400 hover:text-blue-500 hover:bg-blue-50 transition"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
            ...
            <div>
                ...
                {event.location && (
                    <div className="flex items-center gap-1 mt-1.5">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-3 h-3 text-stone-400 flex-shrink-0">
